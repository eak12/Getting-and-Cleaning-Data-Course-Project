...
#step 42 - rename columns of MeantGravity data table to meaningful names.
...
#step 43 - write MeanTGravity.csv
write.csv(MeantGravity,file = "../desktop/GetCleanData/Tidy/MeanTGravity.csv")

#step 44 - find the mean of each column of the data table "tBodyJerk", grouped by subject and activity
...
#step 45 - rename columns of MeanTBodyJerk data table to meaningful names.
...
#step 46 - write MeanTBodyJerk.csv
write.csv(MeanTBodyJerk,file = "../desktop/GetCleanData/Tidy/MeanTBodyJerk.csv")

#step 47 - find the mean of each column of the data table "tMag", grouped by subject and activity
...
#step 48 - rename columns of MeanTMag data table to meaningful names.
...
#step 49 - write MeanTMag.csv
write.csv(MeanTMag,file = "../desktop/GetCleanData/Tidy/MeanTMag.csv")

#step 50 - find the mean of each each column of the data table "fBody", grouped by subject and activity.
...
#step 51 - rename columns of MeanTMag data table to meaningful names.
...
#step 52 - write MeanFourierTransformBody.csv
write.csv(MeanFBody,file = "../desktop/GetCleanData/Tidy/MeanFourierTransformBody.csv")

#step 53 - find the mean of each each column of the data table "fBodyAccJerk", grouped by subject and activity.
...
#step 54 - rename columns of MeanFBodyAccJerk data table to meaningful names.
...
#step 55 - write MeanFourierTransformBodyAccJerk.csv
write.csv(MeanFBodyAccJerk,file = "../desktop/GetCleanData/Tidy/MeanFourierTransformBodyAccJerk.csv")

#step 56 - find the mean of each each column of the data table "fMag", grouped by subject and activity.
...
#step 57 - rename columns of MeanFMag data table to meaningful names.
...
#step 58 - write MeanFourierTransformFMag.csv
write.csv(MeanFMag,file = "../desktop/GetCleanData/Tidy/MeanFourierTransformFMag.csv")

#step 59 - put all dataset into one list
library(plyr)
dflist=list(MeanAngle, MeanFBody, MeanFBodyAccJerk, MeanFMag, MeanTBody, MeanTBodyJerk, MeantGravity, MeanTMag)

#step 60 - join all the dataset from each list
allMeanMeasures<-join_all(dflist)

#step 61 - write a txt file and row name=false

write.table(allMeanMeasures, file = "../desktop/GetCleanData/Tidy/allMeanMeasures.txt",row.names = FALSE)
